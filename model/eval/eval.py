...
def mask():
    ...
    if args.model == 'unet':
        ...
        configs = '/home/jovyan/model/jbnu/my_model/segformer/segformer_mit-b2_512x512_160k_ade20k.py'
        pred_mask_dir = f'{args.output}/segformer_mask/'
    else:
...
def main():
    ...
    if args.model == 'unet':
        ...
        configs = '/home/jovyan/model/jbnu/my_model/segformer/segformer_mit-b2_512x512_160k_ade20k.py'
        maskpath = f'/home/jovyan/logs/segformer_{dataname}/segformer_mask/'
    else:
        print('You cannot use this model')
    ...
    pacc, mIoU, diseases_IoU, f1, oacc = a1['metric']['aAcc'], a1['metric']['mIoU'], a1['metric']['IoU.diseases'], f1, acc
    last = {'acc':pacc, 'mIoU':mIoU, 'diseases_IoU':diseases_IoU, 'f1':f1, 'oacc':acc}
